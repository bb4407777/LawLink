...
> 基于 lawflow-boop/LawLink 的深度二次开发。**完整项目展示 → [legal-ai-portfolio](https://github.com/bb4407777/legal-ai-portfolio)**
>
> 系统运行数据：706 件案件 · 2,034 份文书 · 1,293 条办案记录 · 189+ 次迭代

LawLink 是一个开源、自部署的律师案件 / 项目管理系统。本分支在原项目基础上进行了深度定制与重构，覆盖案件全生命周期的数据模型、自动化工作流引擎、OCR 证据管道等核心增强。
