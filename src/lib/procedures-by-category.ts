...
export const proceduresByCategory: Record<MatterCategory, ProcedureType[]> = {
  ...
  AGENT_FILING: ["NON_LITIGATION_PHASE", "CUSTOM"],
  CONSULTATION: ["NON_LITIGATION_PHASE", "CUSTOM"],
  PUBLIC_SOURCE: ["NON_LITIGATION_PHASE", "CUSTOM"]
};
...
export const standingsByCategory: Record<MatterCategory, LitigationStanding[]> = {
  ...
  AGENT_FILING: ["NON_LITIGATION_PARTY"],
  CONSULTATION: ["NON_LITIGATION_PARTY"],
  PUBLIC_SOURCE: ["NON_LITIGATION_PARTY"]
};
